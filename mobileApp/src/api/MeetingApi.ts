...
export class MeetingApi {
     ...
     */
    public addMeeting(meeting: models.Meeting1, extraHttpRequestParams?: any): Observable<string> {
     ...
     */
    public removeMeeting(meeting: models.Meeting2, extraHttpRequestParams?: any): Observable<{}> {
     ...
     * @param meeting Meeting that needs to be submitted to the backend
     */
    public addMeetingWithHttpInfo(meeting: models.Meeting1, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param meeting Meeting which shall be deleted
     */
    public removeMeetingWithHttpInfo(meeting: models.Meeting2, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/meeting`;
